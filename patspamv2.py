...
class SPAM:
    ...
    def banner(self):
        ...
        title = '\n\n\n---YouToBe Pham Anh Tuan Media Lên Đó Mà Lấy Tool Free ---'
        banner = '''\n 
...
░╚═╝░░░░╚════╝░░╚════╝░╚══════╝
    ...
    def send_otp(self):
        ...
        try:
            ...
            if 'Thành công' in response:
                print(self.format_print("PAT",f"MOMO: {response}"))
            else:
                print(self.format_print("PAT",f"MOMO: "+response))
        except:
            print(self.format_print("PAT",f"MOMO: BAD REQUESTS LIMIT!"))
    def send_code(self):
        json_data = {
                'user': self.phone,
    ...
    def Gbay(self):
        ...
        try:
            ...
            print(self.format_print("PAT",f"GBAY: SUCCESS!"))
        except:
            print(self.format_print("PAT",f"GBAY: ERROR!"))
    ...
    def moca(self):
        ...
        try:
            ...
            print(self.format_print("PAT",f"MOCA: SUCCESS!"))
        except:
            print(self.format_print("PAT",f"MOCA: ERROR!"))
    ...
    def zalopay(self):
        try:
            ...
            print(self.format_print("PAT",f"ZALOPAY: SUCCESS!"))
        except:
            print(self.format_print("PAT",f"ZALOPAY: ERROR!"))
    def tiki(self):
        try:
            json_data = {
                    'phone_number': self.phone,
            ...
            print(self.format_print("PAT",f"TIKI: SUCCESS!"))
        except:
            print(self.format_print("PAT",f"TIKI: ERROR!"))
    def meta_vn(self):
        try:
            params = {
                'api_mode': '1',
            ...
            print(self.format_print("PAT",f"METAVN: SUCCESS!"))
        except:
            print(self.format_print("PAT",f"METAVN: ERROR!"))
    def vntrip(self):
        try:
            json_data = {
                'feature': 'register',
            ...
            print(self.format_print("PAT",f"VNTRIP: SUCCESS!"))
        except:
            print(self.format_print("PAT",f"VNTRIP: ERROR!"))
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("PAT",f"Nhập Số Điện Thoại Cần Spam: "))
            if self.phone != '0374824173':
                if len(self.phone) == 10:
                    break
                print(self.format_print("PAT", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0374824173':
                print(self.format_print("PAT", "LÀM ƠN ĐỪNG SPAM SỐ ĐIỆN THOẠI PAT!"))
            time.sleep(3)
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(3)
        sys.exit('\n'+SPAM().format_print('√', 'Pham Anh Tuan Media'))
